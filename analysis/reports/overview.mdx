...
description: "Understanding Trodo's report types for Web3 analytics"
---

## Overview

Trodo provides four powerful report types, each designed to answer different types of questions about your users' behavior—both off-chain and on-chain.
