...
Trodo indexes transactions from your smart contracts and automatically links them to user profiles via wallet addresses. This creates complete attribution from first website visit to on-chain conversion.
...
1. **Index**: Trodo monitors your contracts for new transactions
