...
description: "Best practices for naming events and properties in Trodo"
---
...
Trodo.track('Swap Completed');     // Title Case with spaces
Trodo.track('swapcompleted');      // No separation
```
...
Trodo.track('token_viewed', { token_address: '0x1234...' });
Trodo.track('button_clicked', { button_id: 'abc123' });
```
...
Trodo.track(`${action}_${object}`);  // Could create thousands of events
...
Trodo.track('wallet_connected', { wallet_address: '0x1234...' });
```
