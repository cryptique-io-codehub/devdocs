...
description: "Supported blockchains across Trodo features"
---

## Overview

Trodo supports multiple blockchains across different features. The level of support varies by feature:
...
Trodo automatically indexes all transactions from the deployment block.
...
Want to request a chain? Email [hello@trodo.ai](mailto:hello@trodo.ai).
