...
Trodo indexes smart contract transactions, events, and interactions across **35 blockchains**. Add your contract address, and we automatically index all historical and real-time transactions.
...
<Steps>
  <Step title="Navigate to Settings">
    Go to **Settings → Contracts** in your [dashboard](https://app.trodo.ai).
  </Step>
  ...
  <Step title="Save & Index">
    Click **Save**. Trodo automatically:
...
For each contract, Trodo indexes:
...
Trodo auto-detects and optimizes indexing for:
...
1. Transaction is indexed by Trodo
...
This is the core value of Trodo—automatic linking of behavior to transactions.
